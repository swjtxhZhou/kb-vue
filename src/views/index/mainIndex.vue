    ...
    <el-row :gutter="20">
      <el-col :span="8">
        <div class="card kjfs">
          ...
          <ul>
            <li><router-link to="/caseKnowledge/search" class="kjfs kjfs-bluee"><span><i class="el-icon-search fa-2x"></i></span><span>检索案例</span></router-link></li>
            <li><router-link to="/designKnowledge/search" class="kjfs kjfs-pinkk"><span><i class="el-icon-search fa-2x"></i></span><span>检索设计知识</span></router-link></li>
