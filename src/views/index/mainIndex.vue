        ...
        <el-row>
          <el-col>
            <div class="card kjfs">
              ...
              <ul>
                <li>
                  <router-link to="/caseKnowledge/search" class="kjfs kjfs-bluee">
                    <span><i class="el-icon-search fa-2x"></i></span>
                    <span>检索案例</span>
                  </router-link>
                </li>
                <li><router-link to="/designKnowledge/search" class="kjfs kjfs-grennn"><span><i class="el-icon-search fa-2x"></i></span><span>检索设计规范</span></router-link></li>
                <li><router-link to="/caseKnowledge/upload" class="kjfs kjfs-bluee"><span><i class="el-icon-upload fa-2x"></i></span><span>案例上传</span></router-link></li>
                <li><router-link to="/designKnowledge/upload" class="kjfs kjfs-grennn"><span><i class="el-icon-upload fa-2x"></i></span><span>设计规范上传</span></router-link></li>
              </ul>
            </div>
          </el-col>
        </el-row>
